...
public class APICommandFactory {
    ...
    public static LoginCommand createLoginCommand(XtbCredentials credentials) throws APICommandConstructionException {
        JSONObject jsonObj = createLoginJsonObject(credentials);
        return new LoginCommand(jsonObj);
    }

    @SuppressWarnings("unchecked")
    private static JSONObject createLoginJsonObject(XtbCredentials credentials) {
    ...
    public static LoginResponse executeLoginCommand(SyncAPIConnector connector, XtbCredentials credentials) throws APICommandConstructionException, APICommunicationException, APIReplyParseException, APIErrorResponse, IOException {
